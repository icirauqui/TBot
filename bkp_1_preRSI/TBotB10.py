...
def get_action_ema(aboveij,updown):
    i1 = 0
    i2 = 0
    cnti = 0
    cnti1 = 0
...
def check_opportunity(data,name,sell,buy):
    if (len(data['ema2'])>=5):
        ...
        iGo12,iPos12 = get_action_ema(above12,1)
        iGo13,iPos13 = get_action_ema(above13,1)
        jGo12,jPos12 = get_action_ema(above12,-1)

        #if (buy and iGo12 and iGo13 and iPos12<=jPos12 and iPos13<=jPos12 and (arrema2[-1]>arrema3[-1])):
        if (buy and iGo12 and iGo13 and iPos12<=jPos12 and iPos13<=jPos12 and (dltarrema1>0.0050*avgarrema1)):
            return True
